...
class Kitten:
    ...
    def move(self):
        ...
        while (
            self.i < number_of_steps
            and self.start_positions_index < number_of_positions
        ):
            ...
            if (
                ...
                if x == None and y == None:
                    ...
                    self.position = [y, x]
                    self.mapc[self.position[0]][self.position[1]] = 1
                    print(self.position)
            else:
...
kittens = [Kitten() for _ in range(1)]
